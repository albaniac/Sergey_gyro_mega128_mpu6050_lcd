...
void MyMenu::link_parent_child(MENU_NODE * parrent_node, MENU_NODE * child_node) {
...
void MyMenu::link_back_next(MENU_NODE * back_node, MENU_NODE * next_node) {
